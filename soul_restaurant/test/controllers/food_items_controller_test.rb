...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { description: @food_item.description, name: @food_item.name, price: @food_item.price, section_id: @food_item.section_id }
    end
  ...
  test "should update food_item" do
    patch :update, id: @food_item, food_item: { description: @food_item.description, name: @food_item.name, price: @food_item.price, section_id: @food_item.section_id }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
